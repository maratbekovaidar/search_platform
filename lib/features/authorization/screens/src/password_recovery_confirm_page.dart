...
class PasswordRecoveryConfirmPage extends StatefulWidget {
  const PasswordRecoveryConfirmPage({Key? key}) : super(key: key);

  @override
  State<PasswordRecoveryConfirmPage> createState() => _PasswordRecoveryConfirmPageState();
}

class _PasswordRecoveryConfirmPageState extends State<PasswordRecoveryConfirmPage> {
