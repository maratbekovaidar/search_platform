...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String objectId, String name, String description, int id});
}
...
class _$_CategoryModel with DiagnosticableTreeMixin implements _CategoryModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CategoryModel(objectId: $objectId, name: $name, description: $description, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, objectId, name, description, id);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      required final int id}) = _$_CategoryModel;
